...
// Taken from here: https://stackoverflow.com/questions/10715170/receiving-rtsp-stream-using-ffmpeg-library
...
int main()
{
  ...
  //open RTSP
  if (avformat_open_input(&format_ctx, "rtsp://admin:admin@192.168.88.52:554/av0_0",
    NULL, NULL) != 0) {
    return EXIT_FAILURE;
  }
